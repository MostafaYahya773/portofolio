...
const MySkills = () => {
  ...
  return (
    <section className="dark:bg-dark-bg-section/30 bg-light-bg-secondery py-16">
      <div className="max-w-[1300px] mx-auto px-3 flex flex-col gap-16">
        <div className="header grid md:grid-cols-2 gap-5 items-start ">
          ...
          <div className="skills flex gap-2 dark:bg-dark-bg-card dark:text-dark-button-text bg-light-tag-bg/90 w-fit md:ms-auto p-1  rounded-full">
